...
import { getAugmentConnection } from '../../../services/gameService'
...
const handleSubmitAugments = () => {
  getAugmentConnection(augments.value[0].name, augments.value[1].name,
    (response) => {
      ...
      <div class="flex flex-col justify-between bg-dork w-80 h-88 rounded-md py-5 px-6">
        ...
        <div>
          <div class="flex justify-between mb-2">
            <div class="text-light text-2xl font-light">Augment connections</div>
        ...
        <div class="mx-auto">
          ...
          :disabled="augments.length < 2" @click="handleSubmitAugments">
            Get connection
          </button>
